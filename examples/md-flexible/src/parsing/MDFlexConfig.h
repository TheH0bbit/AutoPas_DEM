...
class MDFlexConfig {
 public:
  ...
  /**
   * Adds parameters to all missing relevant DEM particle property attributes.
   * @param rad
   * @param young
   * @param poisson
   */
   ...
   */
  enum class FunctorOption { lj12_6, lj12_6_AVX, lj12_6_Globals, DEM };
  ...
  MDFlexOption<FunctorOption, __LINE__> functorOption{
      ...
      "Force functor to use. Possible Values: (lennard-jones lennard-jones-AVX2 lennard-jones-globals DEM)"};
  /**
   * iterations
   */
